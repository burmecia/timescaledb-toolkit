...
extension_sql!(r#"
ALTER FUNCTION toolkit_experimental."run_pipeline" SUPPORT toolkit_pipeline_support;
ALTER FUNCTION toolkit_experimental."add_unstable_element" SUPPORT toolkit_pipeline_support;
